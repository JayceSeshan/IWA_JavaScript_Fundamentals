...
const startingAfterTax = taxAsDecimal * 1 * salary
const type = size + '-' + lodging
const balance = parseFloat(expenses['transport']) + parseFloat(expenses['food']) + parseFloat(rent[type])
const total = startingAfterTax + balance
const finalValue = salary - total
